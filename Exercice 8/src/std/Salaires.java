...
class Salaires {
    ...
    private static String[] classes = {
            ...
            "std.Representant",
            "std.Technicien",
            "std.Manutentionnaire",
            "std.TechnARisque",
            "std.ManutARisque"
    };

    public void mainMenu(){
        System.out.println("Tappez s/S pour saisir les paramètres d'un nouvel employé,");
        System.out.println("Tappez c/C pour lancer le calcul des salaires :");
        ...
        if (userInput.equals("s") || userInput.equals("S")) {
            ...
            System.out.println("Veuillez entrer les lettres indiquées !");
            mainMenu();
        }
    }
    ...
    public void createEmployee() {
        System.out.println("Quel type de vendeur voulez vous créer ? Tappez :");
        System.out.println("1. Pour créer un nouveau vendeur");
        System.out.println("2. Pour créer un nouveau représentant");
        System.out.println("3. Pour créer un nouveau technicien");
        System.out.println("4. Pour créer un nouveau manutentionnaire");
        System.out.println("5. Pour créer un nouveau technicien à risque");
        System.out.println("6. Pour créer un nouveau manutentionnaire à risque");
        int userInput;
        boolean correctNumber = false;
        do{
            while(!reader.hasNextInt()){
                System.out.println("Ce que vous avez entré n'est pas un nombre !");
            ...
            if(userInput >= 1 && userInput <= 6){
                ...
                System.out.println("Veuillez entrer un nombre compris entre 1 & 6 !");
            }
        ...
        System.out.println("Entrez la date d'entrée de l'employé :");
        String date = reader.nextLine();
        System.out.println("Entrez le chiffre d'affaire de l'employé :");
        String chiffreAffaire = reader.nextLine();

        try {
            Employe e = (Employe) Class.forName(classes[userInput - 1])
                    .getConstructor(String.class, String.class, int.class, String.class, double.class)
                    .newInstance(nom, prenom, age, date, chiffreAffaire);
